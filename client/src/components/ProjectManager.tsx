...
export default function ProjectManager({ hasActiveProject, onSave, onLoad, openTrigger }: ProjectManagerProps) {
  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      {open && (
        <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-72 max-w-[90vw] sm:left-auto sm:right-0 sm:translate-x-0 sm:w-80 bg-[#FFFFFF] border border-border rounded-lg shadow-xl z-50 p-3 flex flex-col gap-3">
          {/* Save section */}
          {hasActiveProject && (
